#! /bin/bash
##This creates the custom hardened Librewolf config file
echo -en "
...
if [ $answer = '1' ]; then
	{ echo "Now installing I2P-Java and LibreWolf on a Debian-11 template"
	sleep 2
	apt-get update
	...
	if [ $answer = '2' ]; then
		{ echo "Now installing I2P-Java and LibreWolf on a Whonix-16 WS template"
		sleep 2
